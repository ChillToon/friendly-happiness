...
void SceneManager::LoadSceneTextures()
{
	...
	bReturn = CreateGLTexture(
		"textures/steelone.jpg", "steelone");

	bReturn = CreateGLTexture(
		"textures/steeltwo.png", "steeltwo");

	bReturn = CreateGLTexture(
		"textures/marbelone.jpg", "marbelone");
...
void SceneManager::PrepareScene()
{
	...
	// load the tectures for the 3D scene
	LoadSceneTextures();
...
void SceneManager::RenderScene()
{
	...
	//SetShaderColor(0.863, 0.863, 0.863, 1);

	SetShaderTexture("marbelone");
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(12.0f, 9.0f, 2.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 4.0f, 1.0f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(4.0f, 1.0f, 0.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 2.0f, 8.0f);
	...
	//SetShaderColor(0.439, 0.439, 0.439, 1);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.0f, 2.6f, 0.0f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.0f, 1.0f, 0.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(3.8f, 1.0f, 8.0f);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.1f, 0.3f, 0.0f);

	// COMPUTER MOUSE RIDGE
	// set the XYZ rotation for the mesh
	XrotationDegrees = -80.0f;
	YrotationDegrees = 0.0f;
	ZrotationDegrees = 0.0f;
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(3.7f, 1.2f, 7.8f);
